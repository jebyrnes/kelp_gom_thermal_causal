##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~
##~~## File SPITBALLING                                                    ##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~
##~~## Purpose: Testing various Models before re-incorporating into file github_sg.R##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~
##~~##~                                      ##~~##~~##~~##~~##~
##~~## Primary Goal: Develop a better model, as defined by AIC score and expectations (e.g. Urchins Matter!)
##~~## Sub-goals (1): Test Temperature "inflection point" by setting at 16, 17 & 18ºC
##~~## Sub-=goal (2); Urchins Matter!  Find a way that urchin presence contributes something to model (average/site? higher/lower threshold?)
##~~## Sub-goal (3): Work with time (random/fixed; time-from-event timeseries)
##~~## Basic Model Structure:  Kelp Percent Cover is response variable, Year, Region, Urchin and Temp are response variables
##~~#
##~~## Author:  Thew Suskiewicz, with input by D. Rasher & J.E. Byrnes
##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~
##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~##~~
...
getwd()
#setwd(here::here()) #what??  Jarret wrote this.
